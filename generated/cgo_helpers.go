...
func (x *RKLLMParam) PassRef() (*C.RKLLMParam, *cgoAllocMap) {
	...
	refefead654.skip_special_token, cskip_special_token_allocs = (C._Bool)(x.Skip_special_token), cgoAllocsUnknown
	allocsefead654.Borrow(cskip_special_token_allocs)

	var cis_async_allocs *cgoAllocMap
	refefead654.is_async, cis_async_allocs = (C._Bool)(x.Is_async), cgoAllocsUnknown
...
func (x *RKLLMResult) PassRef() (*C.RKLLMResult, *cgoAllocMap) {
	...
	refeb437fd0.text, ctext_allocs = *(**C.char)(unsafe.Pointer(&x.Text)), cgoAllocsUnknown
...
func (x *RKLLMResult) Deref() {
	...
	x.Text = (*byte)(unsafe.Pointer(x.refeb437fd0.text))
...
func lLMResultCallback3439A4AD(cresult *C.RKLLMResult, cuserdata unsafe.Pointer, cstate C.LLMCallState) {
	if lLMResultCallback3439A4ADFunc != nil {
		result3439a4ad := NewRKLLMResultRef(unsafe.Pointer(cresult))
